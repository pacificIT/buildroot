...
define OTTO_FASTCAMD_INSTALL_INIT_SYSTEMD
	...
	$(INSTALL) -D -m 644 $(@D)/otto-fastcamd-still.service \
		$(TARGET_DIR)/usr/lib/systemd/system/otto-fastcamd-still.service
...
#	ln -fs ../../../../usr/lib/systemd/system/otto-fastcamd-still.service \
#		$(TARGET_DIR)/etc/systemd/system/multi-user.target.wants/otto-fastcamd-still.service
